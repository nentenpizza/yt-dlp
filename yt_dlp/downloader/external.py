...
class CurlFD(ExternalFD):
    ...
    def _make_cmd(self, tmpfilename, info_dict):
        ...
        cmd += self._option('--info-proxy', 'info_proxy')
        cmd += self._option('--x-json-errors', 'x-json-errors')
        cmd += self._option('--download-proxy', 'download_proxy')
...
class Aria2cFD(ExternalFD):
    ...
    def _make_cmd(self, tmpfilename, info_dict):
        ...
        cmd += self._option('--info-proxy', 'info-proxy')
        cmd += self._option('--download-proxy', 'download-proxy')
        cmd += self._option('--x-json-errors', 'x-json-errors')
